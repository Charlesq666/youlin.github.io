...
const experienceObjs: ExperienceType[] = [
  {
    ...
    techImgs: ["/skills/aws.png", "/skills/react.svg", "/skills/ts.png", "/skills/fastapi.jpg", "skills/mongodb.svg", "skills/ec2.png", "skills/python.png", "skills/route53.png", "/skills/html.png", "skills/css.png","skills/docker.png"],
  ...
  }, 
  {
    ...
    techImgs: ["/skills/aws.png", "/skills/vue.png", "/skills/ts.png", "/skills/golang.png", "skills/mysql.png", "skills/python.png", "skills/github.png", "skills/pandas.png", "skills/docker.png", "skills/awslambda.png", "skills/elasticsearch.png", "skills/flask.png", "skills/scrapy.png", "skills/scikit-learn.png"],
